...
<div class="change-avt-box">
	<form id="change_avt_form">
    	<table>
        	<thead>
            	<tr><th colspan="2">Thay Ảnh<input name="aidu" id="aidu" type="hidden" value="<?php echo $_SESSION['idu'];?>"></th></tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                	<td></td><td><input value="Sửa" type="submit" name="doi_avt"></td>
                </tr>
            </tbody>
        </table>
    </form>
