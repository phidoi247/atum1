...
CREATE TABLE IF NOT EXISTS `tblchitietdonhang` (
  ...
  PRIMARY KEY (`id`),
  KEY `ten_hoadon` (`ten_hoadon`),
  KEY `sanpham_id` (`sanpham_id`),
  KEY `loaigiaodich_id` (`loaigiaodich_id`)
...
(2, 'BH001', 'Hà', 1, '1996-10-05', 'Hà Nội', '2014-12-25', 'upload/20141225104323', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '01654667209'),
(4, 'BH002', 'Hùng', 1, '1996-10-05', 'Hà Nội', '2014-12-25', 'upload/20141225050419', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '01654667209'),
(5, 'TK001', 'Hà', 2, '1996-10-05', 'Hà Nội', '2014-12-26', 'upload/20141226081249', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '01654667209'),
(19, 'BH016', 'Trương Bá Nam', 1, '1996-02-08', '1234', '2015-01-17', 'upload/20150117102159', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '124');
