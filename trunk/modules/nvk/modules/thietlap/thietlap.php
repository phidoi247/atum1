	...
	<form id="change_pass_form">
    	<table>
            ...
            <tbody>
                ...
                <tr>
                	<td>Nhập lại mật khẩu Mới:</td><td><input id="re_pass" name="pass" pattern="[A-Za-z0-9]{4,12}" type="password" required></td><td><div class="chk_n_p"></div></td>
                </tr>
                <tr>
