...
<div class="change-pass-box" style="width:490px;float:left">
	<form id="change_pass_form">
    	<table>
            ...
            <tbody>
            	<tr>
                	<td>Nhập mật khẩu cũ:</td><td><input id="old_pass" type="password" pattern=".{4-12}" title="4-12 ký tự" required></td><td width="50"><div class="chk_o_p"></span></td>
                </tr>
                <tr>
                	<td>Nhập mật khẩu Mới:</td><td><input id="new_pass" type="password" pattern=".{4-12}" title="4-12 ký tự" required></td>
                </tr>
                <tr>
